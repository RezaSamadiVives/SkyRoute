...
{
    public class AirlinesController(IService<Airline> airlineService) : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,LogoUrl")] Airline airline)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,LogoUrl")] Airline airline)
        {
            if (id != airline.Id)
            {
                return NotFound();
